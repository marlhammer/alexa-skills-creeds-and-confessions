...
var APP_ID = "amzn1.ask.skill.30f8d922-b1b9-4e09-8af9-d2f9e2f477e8";
...
var wsc = [
	...
	"answer":"Adoption is an act of God’s free grace,a whereby we are received into the number, and have a right to all the privileges, of the sons of God."
	},
	...
	"answer":"Thou shalt not make unto thee any graven image, or any likeness of any thing that is in heaven above, or that is in the earth beneath, or that is in the water under the earth: Thou shalt not bow down thyself to them, nor serve them: for I the LORD thy God am a jealous God, visiting the iniquity of the fathers upon the children unto the third and fourth generation of them that hate me; And shewing mercy unto thousands of them that love me, and keep my commandments."
	},
...
var handlers = {
    ...
    'SCIntent': function () {
        ...
        if (!question) {
            ...
            this.emit(':tellWithCard', error, "Shorter Catechism", error);
            return;
        }
		...
		if (question < 1 || question > 107) {
            error = "Please ask for a question between one and one hundred and seven.";
            this.emit(':tellWithCard', error, "Shorter Catechism", error);
            return;
		}

		var question_data = wsc[question - 1];

        var speech = "Question. " + question_data.question + " Answer. " + question_data.answer;

        this.emit(':tellWithCard', speech, "Shorter Catechism", speech);
    },

...
var APP_ID = "amzn1.ask.skill.baf7188a-f3c1-426c-ab28-5b4222aa8909";
...
var wlc = [
	...
	{
	"question":"What did God first reveal unto man as the rule of his obedience?",
	...
	{
	"question":"Is there any use of the moral law since the fall?",
	...
	{
	"question":"What sins are forbidden in the second commandment?",
	...
	{
	"question":"What doth God require of us, that we may escape his wrath and curse due to us by reason of the transgression of the law?",
...
var handlers = {
    ...
    'LCIntent': function () {
        ...
        if (!question) {
            ...
            this.emit(':tellWithCard', error, "Larger Catechism", error);
            return;
        }
		...
		if (question < 1 || question > 196) {
            error = "Please ask for a question between one and one hundred and ninety six.";
            this.emit(':tellWithCard', error, "Larger Catechism", error);
            return;
		}

		var question_data = wlc[question - 1];

        var speech = "Question. " + question_data.question + " Answer. " + question_data.answer;

        this.emit(':tellWithCard', speech, "Larger Catechism", speech);
    },
